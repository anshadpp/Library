...
<head>
    ...
    <style>
        ...
        .contact-container {
            ...
            width: 100%;
            text-align: center;
            margin: 120px auto 40px auto; /* Margin to avoid navbar overlap */
            flex-grow: 1; /* Allows the container to grow and push footer to the bottom */
        }
        h2 {
            color: #333;
            font-size: 28px;
...
<body>
    ...
    <div class="contact-container">
        ...
        <div class="contact-info">
            <p>For any inquiries or issues, please feel free to contact us through the following:</p>
